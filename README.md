...
- [3. 配置开发环境](#3-配置开发环境)
  - [3.1. Git 与 C++ 开发环境](#31-git-与-c-开发环境)
    - [3.1.1. Ubuntu 16.04+](#311-ubuntu-1604)
  ...
  - [3.2. Qt 5.12.4+](#32-qt-5124)
    - [3.2.1. 包管理器](#321-包管理器)
      - [3.2.1.1. Ubuntu 16.04+](#3211-ubuntu-1604)
  ...
  - [3.3. 第三方库](#33-第三方库)
    - [3.3.1. OpenGL](#331-opengl)
      - [3.3.1.1. Ubuntu 16.04+](#3311-ubuntu-1604)
    ...
    - [3.3.2. SDL 2](#332-sdl-2)
      - [3.3.2.1. Ubuntu 16.04+](#3321-ubuntu-1604)
